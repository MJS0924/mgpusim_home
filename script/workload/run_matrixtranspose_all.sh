...
run_bg "REC" "/root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/REC/run_matrixtranspose_REC.sh"
run_bg "HMG" "/root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/HMG/run_matrixtranspose_HMG.sh"
run_bg "CD" "/root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/CD/run_matrixtranspose_CD.sh"
run_bg "motivation" "/root/mgpusim_home/mgpusim/amd/samples/matrixtranspose/motivation/run_matrixtranspose_motivation.sh"
wait
